...
scoreboard objectives add ironPickup minecraft.picked_up:minecraft.iron_ingot
scoreboard objectives add goldPickup minecraft.picked_up:minecraft.gold_ingot
scoreboard objectives add copperPickup minecraft.picked_up:minecraft.copper_ingot
scoreboard objectives add lapisPickup minecraft.picked_up:minecraft.lapis_lazuli
...
scoreboard objectives add goldPower dummy
scoreboard objectives add copperPower dummy
scoreboard objectives add lapisPower dummy
...
scoreboard players set @a goldPower 50
scoreboard players set @a copperPower 2
scoreboard players set @a lapisPower 20
